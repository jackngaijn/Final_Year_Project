...
\begin{enumerate}
    \item Training Accuracy:
    \begin{itemize}
        \item The training accuracy steadily increases over the epochs, starting from around 60\% and peaking at epoch 5 at 73\%. After that the accuracy drop to around 63\% dramatically. 
    \end{itemize}
    \item Test Accuracy:
    \begin{itemize}
        \item The test accuracy increases rapidly during the inital epochs, peaking at around apoch 4 with a value close to 70\%. After epoch 3, it drop dramatically, the shape is similar with the training accuracy. 
    \end{itemize}
\end{enumerate}
\begin{figure}[!htb]
    \centering
