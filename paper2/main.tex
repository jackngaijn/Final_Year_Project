...
\begin{center} % Center the graph on the page
    ...
    % Input nodes
    \node (x1) [circle, fill=blue!10] {$x_1$};
    \node (x2) [circle, fill=blue!10, right=of x1] {$x_2$};
    \node (x3) [circle, fill=blue!10, right=of x2] {$x_3$};

    % Hidden nodes
    \node (h1) [circle, fill=green!10, above=of x1] {$h_1$};
    \node (h2) [circle, fill=green!10, above=of x2] {$h_2$};
    \node (h3) [circle, fill=green!10, above=of x3] {$h_3$};
    ...
    \node[below=0.5cm of x2, font=\itshape] {Time Steps};
